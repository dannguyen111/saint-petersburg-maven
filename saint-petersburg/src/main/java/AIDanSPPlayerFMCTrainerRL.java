...
public class AIDanSPPlayerFMCTrainerRL extends SPPlayer {

    int numSimulationsPerAction = 10000;
    int playoutTerminationDepth = 4;
    AIDanSPStateFeaturesLR4 features = new AIDanSPStateFeaturesLR4();
    boolean verbose = false;

    public AIDanSPPlayerFMCTrainerRL() {
        super("AIDanSPPlayerFMCTrainerRL");
    }
