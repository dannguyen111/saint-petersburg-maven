...
# Example usage:
best_result = compare_ml_models("AIDanSPTrainingDataFlatMCvsFlatMCRL.csv", ['points_diff', 'unique_aristocrats_points_diff', 'rubles_round_gain_diff_x_rounds_left', 'unique_aristocrats_points_diff_x_rounds_left', 'hand_space_avl_diff', 'cards_in_hand_diff', 'rubles_diff', 'points_diff_x_rounds_left', 'cards_in_hand_diff_x_rounds_left', 'hand_space_avl_diff_x_rounds_left', 'rubles_diff_x_rounds_left', 'points_round_gain_diff', 'points_round_gain_diff_x_rounds_left', 'points_x_rounds_left', 'points_round_gain', 'points_round_gain_x_rounds_left'], "is_winner")
